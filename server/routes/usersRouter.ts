...
import { createUserController, deleteUserController, getAllUsersController, getUserController, updateUserController } from "../controllers/usersController.js";
...
usersRouter.post("/", (req: Request, res: Response) => createUserController(req, res));
